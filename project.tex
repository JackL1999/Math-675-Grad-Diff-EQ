...
\begin{itemize}
    ...
    \item $k =$ Thermal Conductivity, $\quad$ $\rho =$ Density, $\quad$ $c_p =$ Specific Heat\\
\end{itemize}
...
\section*{Real world data Equation}
For a one-dimensional rod, the heat conduction is governed by:
\[
...
\begin{itemize}
    \item $\frac{\partial T}{\partial t} = $ the rate of change of temperature with respect to time
    \item $\frac{\partial^2 T}{\partial x^2} = $ how sensitive a specific point is to gaining or losing heat from its neighbors
    \item $t =$ Time (s), $\quad$ $x = $ Position along the rod (m)
    \item $\alpha = \frac{k}{\rho c_p}$ is the thermal diffusivity,
    \item $k =$ Thermal Conductivity, $\quad$ $\rho =$ Density, $\quad$ $c_p =$ Specific Heat
    \item $T =$ Temperature ($^\circ$C), $\quad$ $T_{\infty} =$ Ambient Temperature ($^\circ$C)
\end{itemize}
