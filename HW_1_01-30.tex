...
\begin{figure}[H]
    \includegraphics[width=0.5\textwidth]{HW_1_Q1aVF.pdf}
    \hspace{1cm}
    \includegraphics[width=0.5\textwidth]{HW_1_Q1a.pdf}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=0.5\textwidth]{HW_1_Q1bVF.pdf}
    \hspace{1cm}
    \includegraphics[width=0.5\textwidth]{HW_1_Q1b.pdf}
\end{figure}
...
\begin{figure}[H]
    \includegraphics[width=0.5\textwidth]{HW_1_Q1cVF.pdf}
    \hspace{1cm}
    \includegraphics[width=0.5\textwidth]{HW_1_Q1c.pdf}
\end{figure}
...
for this part.
\begin{figure}[H]
    \includegraphics[width=0.5\textwidth]{four_graphs_first_two.png}
    \hspace{1cm}
    \includegraphics[width=0.5\textwidth]{four_graphs_last_two.png}
\end{figure}
...
\item[(c)] Now use tech (Mathematica, Python, etc) to plot a complete vector field and some trajectories. \\
    ...
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\textwidth]{HW_1_Q2ca-1.png}
        \caption*{Vector Field: $a=-1$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\textwidth]{HW_1_Q2ca0.png}
    ...
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\textwidth]{HW_1_Q2ca1.png}
        \caption*{Vector Field: $a=1$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.40\textwidth}
        \includegraphics[width=\textwidth]{HW_1_Q2ca2.png}
